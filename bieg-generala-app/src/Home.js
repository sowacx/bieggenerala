      ...
      <div>
        <header>
          <div className="header-container">
            <div className="header-description">
              <h1>
                Bieg/Nordic walking pamięci generała Józefa Dowbora-Muśnickiego
              </h1>
        ...
        <div className="content-container">
          <div className="content">
            <h3>Wstęp</h3>
            <p>
              Setna rocznica wybuchu Powstania Wielkopolskiego obchodzona była
              niezwykle uroczyście. Niemniej przy każdej kolejnej powinniśmy
              oddawać cześć i chwałę lokalnym bohaterom, którzy w 1918 roku
              walczyli z okupantem.
            </p>
            <p>
              101 rocznica wydaje się nam dobrym pretekstem do zainicjowania
              nowego zwyczaju. Coroczny bieg w zimowych warunkach może być dobrą
              do okazją do przypominania społeczeństwu o akcie bohaterstwa z
              dawnych lat.
            </p>
            <p>
              Powstanie miało charaker społecznego, lokalnego zrywu. Nasza
              pierwsza edycja biegu będzie podobna. Uczestnicy to lokalna
              społeczność oraz ich rodzina i znajomi. Logistyka, która jest
              wymagana przy tego zawodach zapewniona została dzięki lokalnym
              darczyńcom i przedsięborcom.
            </p>
            <h3>Trasa</h3>
            <p>
              Trasa biegu wytyczona została głównie przy okolicach Jeziora
              Lusowskiego. Jedna pętlą to trochę ponad 10 kilometrów.
              Najodważniejsi uczesnity będą zatem biegli 10 okrążeń, tak aby na
              mecie mieć przebyte 101 kilometrów.
              <img src={trasa} className="img-trasa"></img>
              <br />
